...
@app.route('/predict.html')#binds to an url
#def formpg():
...
def predict():
    if request.method == "POST":
        ...
        #if (output==1):
            #return render_template('submit.html',prediction_text="Congrats You are eligible to apply for loan")
        #else:
            #return render_template('submit.html',prediction_text="Sorry You are not eligible to apply for loan")
    #else:
        #return render_template('predict.html')
    else:
          return render_template("predict.html")
